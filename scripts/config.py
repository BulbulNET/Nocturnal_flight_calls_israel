...
# Agamon - Birdnet Translation dictionary
import os
from os.path import exists, join, sep, abspath, normpath, basename, dirname
...
# V2.4
MODEL_PATH = r'../model/NFC_southern_israel.tflite' 
MDATA_MODEL_PATH = r'checkpoints/V2.4/BirdNET_GLOBAL_6K_V2.4_MData_Model_FP16.tflite'
LABELS_FILE = r'../model/NFC_southern_israel_Labels.txt'
